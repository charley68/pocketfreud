...
app = Flask(
    __name__,
    static_folder=os.path.join(os.path.dirname(__file__), 'test/static' if is_test else 'static'),
...
app.config["APP_CONFIG"] = load_properties(config_path)

# ----------------- 4. CONFIGURE APP -----------------


# Force minimal cookie settings for all environments
...
app.config.update(
    ...
    REMEMBER_COOKIE_NAME="pf_remember",
...
login_manager.login_view = "login"  # Change to your login route name
...
# User loader function (replace with your user lookup logic)
@login_manager.user_loader
def load_user(user_id):
    # You should fetch the user from your DB here
    # For example:
    from modules.db import get_user_info
